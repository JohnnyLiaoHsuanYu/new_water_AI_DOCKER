...
class ModelDataLoader:
    ...
    def load_resevior_model(self):
        for renn in self.resevior_nums.keys():
            model_path = os.path.join(self.base_path, f'resevior_model/resevior_XGBRegressor_{renn}.joblib')
...
final_file_path = lambda predic_path: os.path.join(predic_path, f'waterAI_result.json')

file_name = final_file_path(predic_path)
